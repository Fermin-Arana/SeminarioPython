...
first_team_name = (input("Ingrese el nombre del primer equipo: "))
first_team = Team(first_team_name)
second_team_name = (input("Ingrese el nombre del segundo equipo: "))
second_team = Team(second_team_name)
third_team = Team("Chacarita")
torneo.add_team(first_team)
torneo.add_team(second_team)
torneo.add_match(first_team, second_team, 4, 2)
torneo.add_match(third_team, second_team, 3, 1)